...
class OcorrenciaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ocorrencium" do
    assert_difference('Ocorrencium.count') do
      post ocorrencia_url, params: { ocorrencium: { data: @ocorrencium.data, descricao: @ocorrencium.descricao, foto: @ocorrencium.foto, localizacao: @ocorrencium.localizacao } }
    end
  ...
  test "should update ocorrencium" do
    patch ocorrencium_url(@ocorrencium), params: { ocorrencium: { data: @ocorrencium.data, descricao: @ocorrencium.descricao, foto: @ocorrencium.foto, localizacao: @ocorrencium.localizacao } }
